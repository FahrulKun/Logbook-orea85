                ...
                <html>
                  ...
                  <body>
                    <div class="offline-container">
                      ...
                      <p>Aplikasi Catatan Harian Komisi Treatment memerlukan koneksi internet untuk berfungsi.</p>
...
self.addEventListener('push', (event) => {
  const options = {
    body: event.data ? event.data.body : 'Ada pembaruan baru di aplikasi Komisi Treatment',
